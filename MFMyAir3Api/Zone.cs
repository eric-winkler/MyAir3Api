namespace Winkler.MFMyAir3Api
{
    public class Zone
    {
        ...
        public double DesiredTemp { get; private set; }
        public double RfStrength { get; private set; }
        ...
        public Zone(IAirconWebClient aircon, int number, XElement zoneData)
        {
            ...
            ActualTemp = double.Parse(zoneData.Element("actualTemp").Value);
            DesiredTemp = double.Parse(zoneData.Element("desiredTemp").Value);
            RfStrength = double.Parse(zoneData.Element("RFstrength").Value);
        ...
        {
            return _aircon.Get("setZoneData?"
                + "zone=" + Number
